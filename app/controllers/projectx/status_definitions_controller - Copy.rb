...
module Projectx
  class StatusDefinitionsController < ApplicationController
    ...
    def index
      ...
      if grant_access?('create', 'projectx_status_definitions') || grant_access?('update', 'projectx_status_definitions')
    ...
    def new
      ...
      if grant_access?('create','projectx_status_definitions')
    ...
    def edit
      ...
      if grant_access?('update',"projectx_status_definitions")
