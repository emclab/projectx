...
module Projectx
  describe TaskDefinitionsController do
    ...
    describe "GET 'index'" do
      ...
      context "'index_global' access right for task definition" do
          it "Has access rights, returns list of 3 project task definitions for a 'index_global' " do
            ...
            assigns(:task_definitions).should eq([@task_def_1, @task_def_2, @task_def_3])
          end

          it "Has no access rights, redirect " do
            ...
            get 'index' , {:use_route => :projectx}
            assigns(:task_definitions).should be_blank
