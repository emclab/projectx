  ...
  describe PaymentsController do
    ...
    describe "GET 'index'" do
      before :each do
        ...
        sales_access_right1 = FactoryGirl.create(:user_access, :role_definition_id => sales_role_def.id, :action => 'index', :resource =>'projectx_payments', :sql_code => 'Projectx::Payment.joins(:contract => {:project => :customer}).where(:customerx_customers => {:zone_id => session[:user_privilege].user_zone_ids})', :rank => 2 )
        sales_access_right2 = FactoryGirl.create(:user_access, :role_definition_id => sales_role_def.id, :action => 'index', :resource =>'projectx_payments', :sql_code => 'Projectx::Payment.joins(:contract => {:project => :customer}).where(:customerx_customers => {:zone_id => session[:user_privilege].user_zone_ids})', :masked_attrs => 'project_num,=project_desp', :rank => 1 )
        sales_access_right3 = FactoryGirl.create(:user_access, :role_definition_id => sales_role_def.id, :action => 'update',:resource =>'projectx_payments', :sql_code => 'record.contract.project.sales_id  == session[:user_id]', :rank => 1 )
        sales_access_right4 = FactoryGirl.create(:user_access, :role_definition_id => sales_role_def.id, :action => 'show',  :resource =>'projectx_payments', :sql_code => 'record.contract.project.sales_id  == session[:user_id]', :rank => 1 )
        sales_access_right5 = FactoryGirl.create(:user_access, :role_definition_id => sales_role_def.id, :action => 'create',:resource =>'projectx_payments', :rank => 1 )
      ...
      context "Has global 'index' access right " do
        before :each do
          ...
          ceo_access_right1 = FactoryGirl.create(:user_access, :action => 'index', :role_definition_id => ceo_role_def.id, :resource => 'projectx_payments' )
          ceo_access_right2 = FactoryGirl.create(:user_access, :action => 'update', :role_definition_id => ceo_role_def.id, :resource => 'projectx_payments' )
          ceo_access_right3 = FactoryGirl.create(:user_access, :action => 'show', :role_definition_id => ceo_role_def.id, :resource => 'projectx_payments' )
          ...
          ceo_access_right5 = FactoryGirl.create(:user_access, :action => 'create', :role_definition_id => ceo_role_def.id, :resource =>'projectx_payments' )
      ...
      context "Has only records 'index' access right " do
        before :each do
          ...
          manager_access_right1 = FactoryGirl.create(:user_access, :action => 'index', :role_definition_id => manager_role_def.id, :resource =>'projectx_payments', :sql_code => 'Projectx::Payment.joins(:contract => {:project => :customer}).where(:customerx_customers => {:zone_id => session[:user_privilege].user_zone_ids})', :rank => 2 )
          manager_access_right2 = FactoryGirl.create(:user_access, :action => 'index', :role_definition_id => manager_role_def.id, :resource =>'projectx_payments', :sql_code => 'Projectx::Payment.joins(:contract => {:project => :customer}).where(:customerx_customers => {:zone_id => session[:user_privilege].user_zone_ids})', :masked_attrs => 'project_num,=project_desp', :rank => 1 )
          manager_access_right3 = FactoryGirl.create(:user_access, :action => 'update', :role_definition_id => manager_role_def.id, :resource =>'projectx_payments', :sql_code => 'record.contract.project.sales_id  == session[:user_id]', :rank => 1 )
          manager_access_right4 = FactoryGirl.create(:user_access, :action => 'show', :role_definition_id => manager_role_def.id, :resource =>'projectx_payments', :sql_code => 'record.contract.project.sales_id  == session[:user_id]', :rank => 1 )
          manager_access_right5 = FactoryGirl.create(:user_access, :action => 'create', :role_definition_id => manager_role_def.id, :resource =>'projectx_payments', :rank => 1 )
      ...
      context "Has no 'index' access right " do
        before :each do
          ...
          sales_access_right6 = FactoryGirl.create(:user_access, :action => 'show', :role_definition_id => sales_role_def2.id, :resource =>'customerx_customers', :sql_code => 'Projectx::Payment.joins(:contract => :project => :customer).where(:customerx_customers => {:zone_id => session[:user_privilege].user_zone_ids})', :rank => 1 )
    ...
    describe "GET new" do
      ...
      context "Has access right for 'new' project" do
        before :each do
          sales_role_def = FactoryGirl.create(:role_definition, :name => 'sales', :brief_note => "sales role")
          sales_access_right1 = FactoryGirl.create(:user_access, :action => 'create', :role_definition_id => sales_role_def.id, :resource =>'projectx_payments', :rank => 1 )
...
=begin
    describe "GET search" do
      ...
      context "Has access right for 'search' project" do
        before :each do
          sales_role_def = FactoryGirl.create(:role_definition, :name => 'sales', :brief_note => "sales role")
          sales_access_right1 = FactoryGirl.create(:user_access, :action => 'search', :role_definition_id => sales_role_def.id, :resource =>'projectx_payments', :rank => 1 )
...
=begin
    describe "GET 'search_results'" do
      before :each do
        ...
        sales_role_def = FactoryGirl.create(:role_definition, :name => 'sales', :brief_note => "sales role")
        sales_access_right1 = FactoryGirl.create(:user_access, :role_definition_id => sales_role_def.id, :action => 'search', :resource =>'projectx_payments', :sql_code => 'Projectx::Payment.joins(:contract => {:project => :customer}).where(:customerx_customers => {:zone_id => session[:user_privilege].user_zone_ids})', :rank => 2 )
        sales_access_right2 = FactoryGirl.create(:user_access, :role_definition_id => sales_role_def.id, :action => 'search', :resource =>'projectx_payments', :sql_code => 'Projectx::Payment.joins(:contract => {:project => :customer}).where(:customerx_customers => {:zone_id => session[:user_privilege].user_zone_ids})', :masked_attrs => 'project_num,=project_desp', :rank => 1 )
        sales_access_right3 = FactoryGirl.create(:user_access, :role_definition_id => sales_role_def.id, :action => 'update',:resource =>'projectx_payments', :sql_code => 'record.contract.project.sales_id  == session[:user_id]', :rank => 1 )
        sales_access_right4 = FactoryGirl.create(:user_access, :role_definition_id => sales_role_def.id, :action => 'show',  :resource =>'projectx_payments', :sql_code => 'record.contract.project.sales_id  == session[:user_id]', :rank => 1 )
        sales_access_right5 = FactoryGirl.create(:user_access, :role_definition_id => sales_role_def.id, :action => 'create',:resource =>'projectx_payments', :rank => 1 )
        sales_access_right6 = FactoryGirl.create(:user_access, :role_definition_id => sales_role_def.id, :action => 'show',  :resource =>'customerx_customers', :sql_code => 'record.sales_id  == session[:user_id]' )
      ...
      context "Has individual 'search_results' access right " do
        ...
        it "returns projects list for this individual user" do
          session[:user_id] = @individual_3_u.id
          session[:user_privilege] = Authentify::UserPrivilegeHelper::UserPrivilege.new(@individual_3_u)
          get 'search_results' , {:use_route => :projectx, :payment => {:zone_id_s => @z3.id.to_s, :sales_id_s => @individual_3_u.id.to_s, :customer_id_s => @cust3.id.to_s, :search_option_s => 'Search'} }
          assigns(:s_s_results_details).models.should =~ [@paymnt3]
        end

        it "returns projects search results list for this individual user" do
          session[:user_id] = @individual_2_u.id
          session[:user_privilege] = Authentify::UserPrivilegeHelper::UserPrivilege.new(@individual_2_u)
          get 'search_results' , {:use_route => :projectx, :payment => {:zone_id_s => @z2.id.to_s, :sales_id_s => @individual_2_u.id.to_s, :customer_id_s => @cust2.id.to_s, :search_option_s => 'Search'}}
          assigns(:s_s_results_details).models.should =~ [@paymnt2, @paymnt5]
        end
      end
      ...
      context "Has global 'search_results' access right " do
        before :each do
          ...
          ceo_access_right1 = FactoryGirl.create(:user_access, :action => 'search', :role_definition_id => ceo_role_def.id, :resource => 'projectx_payments' )
          ceo_access_right2 = FactoryGirl.create(:user_access, :action => 'update', :role_definition_id => ceo_role_def.id, :resource => 'projectx_payments' )
          ceo_access_right3 = FactoryGirl.create(:user_access, :action => 'show', :role_definition_id => ceo_role_def.id, :resource => 'projectx_payments' )
          ceo_access_right4 = FactoryGirl.create(:user_access, :action => 'show', :role_definition_id => ceo_role_def.id, :resource =>'customerx_customers' )
          ceo_access_right5 = FactoryGirl.create(:user_access, :action => 'create', :role_definition_id => ceo_role_def.id, :resource =>'projectx_payments' )
        ...
        it "returns payments list " do
          session[:user_id] = @ceo_u.id
          session[:user_privilege] = Authentify::UserPrivilegeHelper::UserPrivilege.new(@ceo_u)
          get 'search_results' , {:use_route => :projectx, :payment => {:zone_id_s => @z1.id.to_s, :sales_id_s => @ceo_u.id.to_s, :customer_id_s => @cust3.id.to_s, :search_option_s => 'Search'}}
          assigns(:s_s_results_details).models.should =~ [@paymnt1, @paymnt2, @paymnt3, @paymnt4, @paymnt5]
        end
      end
      ...
      context "Has only records 'search_results' access right " do
        before :each do
          manager_group = FactoryGirl.create(:sys_user_group, :user_group_name => 'regional_manager', :group_type_id => @type_of_user.id, :zone_id => @z2.id)
          manager_role_def = FactoryGirl.create(:role_definition, :name => 'manager', :brief_note => "manager role")
          manager_access_right1 = FactoryGirl.create(:user_access, :action => 'search', :role_definition_id => manager_role_def.id, :resource =>'projectx_payments', :sql_code => 'Projectx::Payment.joins(:contract => {:project => :customer}).where(:customerx_customers => {:zone_id => session[:user_privilege].user_zone_ids})', :masked_attrs => 'project_num,=project_desp', :rank => 1 )
          manager_access_right3 = FactoryGirl.create(:user_access, :action => 'update', :role_definition_id => manager_role_def.id, :resource =>'projectx_payments', :sql_code => 'record.contract.project.sales_id  == session[:user_id]', :rank => 1 )
          manager_access_right4 = FactoryGirl.create(:user_access, :action => 'show', :role_definition_id => manager_role_def.id, :resource =>'projectx_payments', :sql_code => 'record.contract.project.sales_id  == session[:user_id]', :rank => 1 )
          manager_access_right5 = FactoryGirl.create(:user_access, :action => 'create', :role_definition_id => manager_role_def.id, :resource =>'projectx_payments', :rank => 1 )
          manager_access_right6 = FactoryGirl.create(:user_access, :action => 'show', :role_definition_id => manager_role_def.id, :resource =>'customerx_customers', :sql_code => 'record.sales_id  == session[:user_id]' )
        ...
        it "returns projects list " do
          session[:user_id] = @manager_u.id
          session[:user_privilege] = Authentify::UserPrivilegeHelper::UserPrivilege.new(@manager_u)
          get 'search_results' , {:use_route => :projectx, :payment => {:zone_id_s => @z2.id.to_s, :sales_id_s => @manager_u.id.to_s, :customer_id_s => @cust2.id.to_s, :search_option_s => 'Search'}}
          assigns(:s_s_results_details).models.should =~ [@paymnt2, @paymnt5]
        end
      end
      ...
      context "Has no 'search_results' access right " do
        ...
        it "returns an empty list " do
          session[:user_id] = @individual_6_u.id
          session[:user_privilege] = Authentify::UserPrivilegeHelper::UserPrivilege.new(@individual_6_u)
          get 'search_results' , {:use_route => :projectx, :payment => {:search_option_s => 'Search'}}
          assigns(:payments).should be_blank
