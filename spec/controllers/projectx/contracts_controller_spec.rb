  ...
  describe ContractsController do
    ...
    describe "GET new" do
      context "Has no access right for 'new' project " do
        ...
        it "redirect with insufficient right " do
          ...
          assigns(:contracts).should be_blank
          response.should redirect_to URI.escape(SUBURI + "/authentify/view_handler?index=0&msg=Insufficient Access Right! for action=new and resource=projectx/contracts")
        end
      end
    ...
    describe "GET Create" do
      context "Has no access right for 'create' project " do
        ...
        it "redirect with insufficient right " do
          ...
          assigns(:contracts).should be_blank
          response.should redirect_to URI.escape(SUBURI + "/authentify/view_handler?index=0&msg=Insufficient Access Right! for action=create and resource=projectx/contracts")
        end
    ...
    describe "GET 'search_results'" do
      before :each do
        ...
        @prj2 = FactoryGirl.create(:project, :name => 'project2', :project_desp => 'project2', :project_num => 'num2', :sales_id => @individual_2_u.id,:last_updated_by_id => @individual_1_u.id, :customer_id => @cust2.id )
        @prj3 = FactoryGirl.create(:project, :name => 'project3', :project_desp => 'project3', :project_num => 'num3', :sales_id => @individual_3_u.id,:last_updated_by_id => @individual_3_u.id, :customer_id => @cust3.id )
        @prj4 = FactoryGirl.create(:project, :name => 'project4', :project_desp => 'project4', :project_num => 'num4', :sales_id => @individual_4_u.id,:last_updated_by_id => @individual_4_u.id, :customer_id => @cust1.id )
        @prj5 = FactoryGirl.create(:project, :name => 'project5', :project_desp => 'project5', :project_num => 'num5', :sales_id => @individual_5_u.id,:last_updated_by_id => @individual_5_u.id, :customer_id => @cust2.id )
